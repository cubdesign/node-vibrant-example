...
const vibrantResultList: VibrantResult[] = [
  ...
  {
    preview: "http://localhost:3000/images/max-zhang-gkdyrA_eOo8-unsplash.jpg",
    emoji: null,
    top: {
      label: "Vibrant",
      rgb: [224, 112, 57],
  ...
  {
    preview: "http://localhost:3000/images/zhang_d-cCatH3q6o9M-unsplash.jpg",
    emoji: null,
    top: {
      label: "DarkMuted",
      rgb: [56, 66, 71],
